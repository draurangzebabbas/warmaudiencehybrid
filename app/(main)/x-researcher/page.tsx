    ...
    return (
        <div className="p-0 space-y-6">
            <div className="px-6 pt-6 md:px-8 md:pt-8 flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight">X (Twitter) Lead Research Dashboard</h1>
                <p className="text-muted-foreground text-sm">
                    Collect and organize profile data from X for market research and outreach.
                </p>
            </div>
            ...
            <div className="px-6 md:px-8 pb-8">
                <Card className="w-full border-primary/5 shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>Select an extraction method and provide valid X URLs.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Tabs defaultValue="profiles" className="space-y-6">
                            ...
                            <TabsContent value="profiles" className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Enter X profile URLs or usernames, one per line.
                                    </p>
                                    <Textarea
                            ...
                            <TabsContent value="engagers" className="space-y-4">
                                <div className="space-y-2">
                                    <Label>X Post URLs</Label>
                                    <p className="text-xs text-muted-foreground">
                                        Enter X post URLs, one per line.
                                    </p>
                                    <Textarea
                                        placeholder="https://www.x.com/p/..."
                                        rows={12}
                                        value={postUrls}
                            ...
                            <TabsContent value="followers" className="space-y-4">
                                <div className="space-y-2">
                                    <Label>X Profile URLs or Usernames</Label>
                                    <p className="text-xs text-muted-foreground">
                                        Enter X profile URLs or usernames to extract their audience, one per line.
                                    </p>
                                    <Textarea
                                        placeholder="https://www.x.com/username&#10;username2"
                                        rows={12}

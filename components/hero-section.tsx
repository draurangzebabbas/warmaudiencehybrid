                        ...
                        <div className="mx-auto max-w-7xl px-6 md:px-12">
                            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                                <Link
                                    ...
                                    <span className="text-sm">Automate your LinkedIn audience intelligence today</span>
                                ...
                                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                                    Infinite LinkedIn <br /> Audience Research at Scale
                                </h1>
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">
                                    Transform LinkedIn into your personal data engine. Extract profiles, monitor competitors, and enrich audience profiles automatically with our high-speed extraction pipeline.
                                </p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">
                                    The ultimate LinkedIn platform for automated audience research and profile extraction.
                                </p>
                                ...
                                <div className="mt-8">
                                    <Button
                                        ...
                                        <Link href={session ? "/dashboard" : "/signup"}>
                                            ...
                                            <span className="text-nowrap">{session ? "Go to Dashboard" : "Start Researching"}</span>
                                        </Link>
                                    </Button>
                                </div>
                            </div>
                                ...
                                <Swiper
                                    ...
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            <div className="mx-auto h-fit w-full flex items-center justify-center gap-2">
                                                <Rocket className="size-8 text-primary" />
                                                <span className="text-2xl font-bold">WarmAudience</span>
                                            </div>
                                            <p className="mt-6 text-center text-lg font-medium">Extract 10x Faster</p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">Secure & Scalable</p>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide className="px-2">
                                        <div className="bg-background rounded-(--radius) h-44 max-w-lg border p-9">
                                            ...
                                            <p className="mt-6 text-center text-lg font-medium">Production Ready for You</p>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                            </div>
